...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`Creating shipping2 label for shipment ${shipmentId} with rate ${rateId}`);
    ...
    const fileName = `shipping2_label_${shipmentId}_${Date.now()}.pdf`;
    ...
    console.error('Error in create-shipping2-label function:', error);
    return new Response(
