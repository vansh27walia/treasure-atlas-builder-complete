...
      <div className="text-center py-12 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 rounded-2xl border border-green-200">
...
            </div>
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Batch Label Actions</h2>
              <p className="text-gray-600">Choose an option for your batch labels</p>
            </div>
          </div>
          
          {/* Action Buttons */}
          <div className="flex flex-wrap gap-4 justify-center"> {/* Added justify-center for better alignment */}
            <Button
...
              className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white shadow-lg h-20 flex-col"
              size="lg"
            >
...
              className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-lg h-20 flex-col"
              size="lg"
            >
              <Mail className="h-6 w-6 mb-2" />
              <div className="text-center">
                <div className="font-bold">Email Labels</div>
              </div>
            </Button>
          </div>
        </Card>
