    ...
    <div className="mb-6">
      <div className="flex justify-between items-start mb-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Upload any CSV file - AI will map your headers to shipping format automatically
          </p>
        </div>
      ...
      <Alert className="border-blue-200 bg-blue-50 mb-4">
        ...
        <AlertDescription className="text-blue-800">
          ...
          Our AI will analyze your file and suggest mappings to the shipping format. 
      ...
      <Alert className="border-green-200 bg-green-50">
        ...
        <AlertDescription className="text-green-800">
          <strong>Live Shipping Integration:</strong> All rates are fetched live from shipping API 
