  ...
  const renderDynamicInputs = () => {
    if (shippingType === 'usps_flat_rate') {
      return <div className="space-y-3">
          ...
          <Select onValueChange={value => setDimensions({
          ...dimensions,
          weight: value
        })}>
            <SelectTrigger>
            ...
            <SelectContent>
              {flatRateBoxes.map(box => <SelectItem key={box} value={box}>{box}</SelectItem>)}
            </SelectContent>
          </Select>
        </div>;
    }
    if (shippingType === 'envelope') {
      return <div className="grid grid-cols-3 gap-3">
          <div>
            ...
            <Input value={dimensions.length} onChange={e => setDimensions({
            ...dimensions,
          ...
          <div>
            ...
            <Input value={dimensions.width} onChange={e => setDimensions({
            ...dimensions,
          ...
          <div>
            ...
            <Input value={dimensions.height} onChange={e => setDimensions({
            ...dimensions,
    ...
    if (['box', 'fedex', 'ups', 'dhl'].includes(shippingType)) {
      return <div className="space-y-3">
          <div>
            ...
            <Input value={dimensions.weight} onChange={e => setDimensions({
            ...dimensions,
            weight: e.target.value
          })} placeholder="0" />
          </div>
          {shippingType === 'box' && <div className="grid grid-cols-3 gap-3">
              <div>
                <Label>Length (in)</Label>
                <Input value={dimensions.length} onChange={e => setDimensions({
              ...dimensions,
