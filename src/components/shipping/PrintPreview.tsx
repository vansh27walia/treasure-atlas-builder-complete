...
          {/* MODIFIED: flex-1 to allow this section to grow and fill the remaining space */}
          <div className="flex-1 flex flex-col pt-4 overflow-hidden">
            {/* Tabs for Preview/Download/Email */}
            {/* MODIFIED: flex-1 to make the tabs container fill the remaining space */}
...
              {/* MODIFIED: Added flex-1 and overflow-y-auto to this container */}
...
              {/* MODIFIED: Added flex-1 and a min-h-0 to allow the inner container to shrink as needed */}
              {/* overflow-y-auto added to allow scrolling if content overflows */}
              <div className="flex-1 p-4 bg-gray-50 border rounded-lg overflow-y-auto min-h-0">
...
            onClick={() => handleDownload('pdf')}
            disabled={isRegeneratingLabel || !currentPreviewUrl}
            className="h-9 px-6 bg-blue-50 hover:bg-blue-100 text-blue-700 border-blue-200"
          >
            <Download className="h-4 w-4 mr-2" />
            Download PDF
          </Button>
