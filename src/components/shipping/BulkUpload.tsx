...
const BulkUpload: React.FC = () => {
  ...
  return <>
      <div className={`min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 transition-all duration-300 ${aiPanelOpen ? 'mr-72' : ''}`}>
        ...
        <div className="container mx-0 py-0 px-0">
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
            <CardContent className="p-8 rounded-xl mx-0 px-[10px]">
              ...
              {uploadStatus === 'editing' && results && <div className="space-y-8 mx-0 px-[10px]">
