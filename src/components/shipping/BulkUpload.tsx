  ...
  return (
    <>
      <div className={`min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 transition-all duration-300 ${aiPanelOpen ? 'mr-96' : ''}`}>
        ...
        {/* Chatbot Toggle Button - Only show during editing phase */}
        {uploadStatus === 'editing' && !chatbotOpen && (
          <Button
            onClick={() => setChatbotOpen(true)}
            className="fixed bottom-4 right-4 z-40 w-14 h-14 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 shadow-2xl hover:shadow-3xl transition-all duration-300"
          >
      ...
      {/* Universal Chatbot for Bulk Shipping */}
