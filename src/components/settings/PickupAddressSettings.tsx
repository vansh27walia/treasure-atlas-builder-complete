...
interface AddressFormProps {
  ...
  // 'enableGoogleAutocomplete' prop has been removed from this interface
}
...
const AddressForm: React.FC<AddressFormProps> = ({
  ...
  // 'enableGoogleAutocomplete' has been removed from component destructuring
}) => {
  ...
  // Replaced handleGooglePlaceSelected from InstantAddressForm's logic
  const handleGooglePlaceSelected = (place: GoogleMapsPlace) => {
    try {
      ...
      const { street1, city, state, zip } = extractAddressComponents(place); // Mirroring InstantForm's extraction
      ...
      // Using shouldValidate and shouldDirty as in InstantAddressForm
      if (street1) {
      ...
      // If your extractAddressComponents also provides 'country', you can uncomment/add this:
      // if (country) {
  ...
  // 'handleFullAddressPopulated' has been removed as it was not present in the working InstantAddressForm logic
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                {/* Simplified AddressAutoComplete usage, removed conditional 'enableGoogleAutocomplete' */}
                <AddressAutoComplete 
                  placeholder="Enter your address"
                  defaultValue={field.value}
                  onAddressSelected={handleGooglePlaceSelected}
                  onChange={handleAddressLineChange}
                  // 'onFullAddressPopulated' removed
