      ...
      <div className="p-8 space-y-8">
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-green-100">
            ...
            <CardContent>
              ...
              <p className="text-xs text-green-600 mt-1">
                {dashboardData.totalShipments > 0 ? `${Math.round(dashboardData.deliveredShipments / dashboardData.totalShipments * 100)}% success rate` : 'No shipments yet'}
              </p>
            </CardContent>
          </Card>
        ...
        <div className="text-center bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-lg p-8 text-white shadow-xl">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            ...
            <Button size="lg" onClick={() => navigate('/import')} variant="outline" className="border-white text-white hover:bg-white hover:text-purple-600 shadow-lg">
