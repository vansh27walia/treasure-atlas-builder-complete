...
import { FileText, Upload, CheckCircle, Download, Info, Sparkles, Brain, Bot } from "lucide-react"; // 👈 NEW: Import Bot icon
...
const BulkUploadPage = () => {
  ...
  const [currentBulkStep, setCurrentBulkStep] = React.useState<BulkUploadStep>("upload");
  const [completedSteps, setCompletedSteps] = React.useState<BulkUploadStep[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="container mx-auto py-[6px] px-[5px]">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        Upload your CSV file and let our AI handle the rest. Smart mapping, live rates, and instant
            label             generation.          {" "}
          </p>
                 {" "}
        </div>
                {/* 👈 CHANGE 1: Unified AI Chatbot - Moved to the top and wrapped in a Card */}       {" "}
        <Card className="max-w-6xl mx-auto mb-8 border-2 border-purple-300 shadow-xl bg-white/80 backdrop-blur-sm">
                   {" "}
          <CardHeader className="bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-t-lg p-4">
                       {" "}
            <CardTitle className="flex items-center text-xl">
                            <Bot className="h-6 w-6 mr-3" />              AI Assistant & Explanation            {" "}
            </CardTitle>
                       {" "}
            <CardDescription className="text-purple-100">
                            Need help? Ask the AI about course numbers, upload details, or general shipping queries.    
                     {" "}
            </CardDescription>
                     {" "}
          </CardHeader>
        ...
                {/* 👈 CHANGE 2: Progress Bar - Placed after the AI Chatbot and before the tabs */}
               {" "}
        <BulkUploadProgressBar
          currentStep={currentBulkStep}
          completedSteps={completedSteps} // Add margin-bottom to separate it from the TabsList below
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="max-w-6xl mx-auto px-0">
          ...
          <TabsList className="grid w-full grid-cols-2 mb-8 bg-white shadow-lg rounded-lg p-1">
            ...
            >
                            <Upload className="h-4 w-4 mr-2" />              Smart Upload            {" "}
            </TabsTrigger>
                       {" "}
            <TabsTrigger
              value="template"
              className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-600 data-[state=active]:to-indigo-600 data-[state=active]:text-white"
            >
                            <FileText className="h-4 w-4 mr-2" />              Template & Guide            {" "}
            </TabsTrigger>
                     {" "}
          </TabsList>
                   {" "}
          ...
          <TabsContent value="template" className="space-y-8">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <AlertDescription className="text-green-800">
                                        <strong className="font-semibold">Shipping Integration:</strong> This template
                    follows recommended                     CSV format for bulk shipping. Pickup addresses are selected
                    from your saved addresses - only                     recipient details go in the CSV.              
                       {" "}
                  </AlertDescription>
                                 {" "}
                </div>
            ...
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-300">
              ...
              <CardHeader className="bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-t-lg">
                               {" "}
                <CardTitle className="flex items-center text-xl">
                                    <FileText className="h-6 w-6 mr-3" />                  Bulk Shipping CSV Template  
                               {" "}
                </CardTitle>
                               {" "}
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-6">
                  ...
                  <Button
                    ...
                    size="lg"
                  >
                                        <Download className="h-5 w-5 mr-2" />                    Download Shipping
                    Template                  {" "}
                  </Button>
                                 {" "}
                </div>
            ...
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
              ...
              <CardHeader>
                ...
                <CardTitle className="flex items-center text-xl text-center font-normal">
                                    <CheckCircle className="h-6 w-6 mr-3 text-green-600" />                  Smart
                  Shipping Workflow                {" "}
                </CardTitle>
                               {" "}
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <h4 className="font-semibold text-green-600 mb-4 text-lg flex items-center">
                                            <CheckCircle className="w-5 h-5 mr-2" />                      Required
                      Fields                    {" "}
                    </h4>
                                       {" "}
                  ...
                  <div>
                    ...
                    <h4 className="font-semibold text-blue-600 mb-4 text-lg flex items-center">
                                            <Info className="w-5 h-5 mr-2" />                      Optional Fields      
                                   {" "}
                    </h4>
                                       {" "}
                    ...
                    <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200">
                      ...
                      <h5 className="font-semibold text-blue-800 mb-3 flex items-center">
                                                <Brain className="w-5 h-5 mr-2" />                        AI Magic:    
                                         {" "}
                      </h5>
                                           {" "}
                      <p className="text-sm text-blue-700 leading-relaxed">
                                                Don't worry about exact field names! Our AI can automatically detect and
                        map columns like                         "Customer Name" → "to_name" or "ZIP Code" → "to_zip".
      ...
            {/* 👈 REMOVED: The old ShipAIChatbot was here. It's now moved up. */}   {" "}
    </div>
  );
};
