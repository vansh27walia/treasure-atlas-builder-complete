...
const BulkUploadPage = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="container mx-auto py-6 px-4">
        ...
        {uploadProgress > 0 && uploadProgress < 100 && <div className="max-w-6xl mx-auto px-0 mb-6">
        ...
        {/* 2. TABS: Only show when upload hasn't started processing */}
        {uploadStatus === 'idle' ? (
          <Tabs value={activeTab} onValueChange={setActiveTab} className="max-w-6xl mx-auto px-0">
            ...
            <TabsContent value="upload" className="space-y-0">
              <BulkUpload onUploadStatusChange={handleUploadStatusChange} />
            </TabsContent>
